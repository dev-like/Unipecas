                    ...
                    <div class="modal-body">
                      <div class="row">
                        <div class="form-group col-md-12">
                          {!! Form::label('imagem', 'Imagem do Parceiro') !!}
                          <input type="file" name="imagem" class="filestyle" data-placeholder="Enviar imagem" data-btnClass="btn-light">
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-7">
                          {{ Form::label('textprod1', 'Descrição') }}
                          {{ Form::text('textprod1', null, array('class' => 'form-control', 'autofocus','maxlength' => '150','required')) }}
                        </div>
                        <div class="form-group col-md-5">
                          {!! Form::label('imgprod1', 'Imagem do Produto 1') !!}
                          <input type="file" name="imgprod1" class="filestyle" data-placeholder="Enviar imagem" data-btnClass="btn-light">
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-7">
                          {{ Form::label('textprod2', 'Descrição') }}
                          {{ Form::text('textprod2', null, array('class' => 'form-control', 'autofocus','maxlength' => '150','required')) }}
                        </div>
                        <div class="form-group col-md-5">
                          {!! Form::label('imgprod2', 'Imagem do Produto 2') !!}
                          <input type="file" name="imgprod2" class="filestyle" data-placeholder="Enviar imagem" data-btnClass="btn-light">
                        </div>
                      </div>
                    </div>
    ...
    <table id="datatable" class="table table-bordered">
        ...
        <tbody>
          @foreach($parceiros as $parceiro)
            <tr>
                <td><img width="320px" src="{{ asset('uploads/parceiro/'. $parceiro->imagem) }}"></td>
                <td width="11%">
                  <span class="hint--top" aria-label="Editar Parceiro"><a href="{{ route('parceiros.edit', $parceiro->id) }}" style="border-radius: 50%" class="btn btn-warning waves-effect"> <i class="fa fa-pencil m-r-5"></i></a></span>
